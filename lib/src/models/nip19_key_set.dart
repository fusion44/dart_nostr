...
class Nip19KeySet {
  ...
  Nip19KeySet.from(String key, {this.relayUrl = ''}) {
    if (key.startsWith('npub1')) {
      pubKeyBech32 = key;
      pubKeyHex = _decodePublicKey(key);

      return;
    }

    pubKeyHex = key;
    pubKeyBech32 = _encodePublicKey(key);
  }
  ...
  String _encodePublicKey(String publicKeyHex) {
    ...
    if (relayUrl.isNotEmpty) {
      ...
      var relayBytes = utf8.encode(relayUrl);
